...
const RandomQuote = () => {
  ...
  return (
    <div className="w-[80%] sm:w-full h-full flex flex-col justify-center items-center">
      {quoteObj.quote === '' && (
        <div
          id="loading"
          className="w-[80%] max-w-[510px] h-[70%] max-h-[500px] bg-white p-11 rounded-2xl shadow-2xl flex flex-col justify-center items-center"
        >
      ...
      {quoteObj.quote.length > 2 && (
        <>
          ...
          >
            <h1 className="mb-3 text-lg sm:text-3xl font-medium text-darkBlue">
              {quoteObj.quote}
            </h1>
            <p className="text-sm sm:text-xl mt-2">- {quoteObj.author}</p>
